...
export const Navbar = () => {
  ...
  return (
    <div>
      <nav
        className={`flex items-center justify-between px-4 py-3 text-black  container mx-auto ${
          location.pathname === "/" ? "mb-0" : "mb-10"
        }`}
      >
        <div className="scale-100 cursor-pointer rounded-2xl px-3 py-2 text-xl font-semibold   flex gap-5 items-center">
          <h2>Logo</h2>
          <div>
            <h1 className="font-tiro">হোগলা বেতকা মাধ্যমিক বিদ্যালয়</h1>
      ...
      {location.pathname === "/" && (
        <div className="w-full h-1 shadow-2xl bg-[#00CCDD] "></div>
      )}
    </div>
  );
};
